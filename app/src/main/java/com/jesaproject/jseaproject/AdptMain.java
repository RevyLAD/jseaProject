...
public class AdptMain extends BaseExpandableListAdapter {
    ...
    public AdptMain(FragmentActivity context, ArrayList<String> arrayGroup, HashMap<String, ArrayList<String>> arrayChild){
        super();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if( v == null){
            ...
            v = inflater.inflate(R.layout.listviewitem_group, null);
        }
